...
const BackupList = ({ refresh }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)(material_1.List, Object.assign({ component: "nav" }, { children: backups.slice(startIndex, endIndex).map((backup) => ((0, jsx_runtime_1.jsx)(material_1.ListItem, Object.assign({ button: true, selected: backup === selectedBackup, onClick: (event) => handleListItemClick(event, backup) }, { children: (0, jsx_runtime_1.jsx)(material_1.ListItemText, { primary: backup }) }), backup))) })), (0, jsx_runtime_1.jsx)(material_1.Button, Object.assign({ disabled: !selectedBackup || loading, onClick: handleOpen, variant: "contained", color: "primary" }, { children: loading ? ((0, jsx_runtime_1.jsx)(material_1.CircularProgress, { size: 24 })) : (`Aplicar respaldo: ${selectedBackup}`) })), (0, jsx_runtime_1.jsx)("div", Object.assign({ style: {
                    marginTop: "1rem",
