...
function CreateUser() {
    ...
    return ((0, jsx_runtime_1.jsx)(Box_1.default, Object.assign({ sx: {
            ...
            alignItems: "center",
                ...
                alignItems: "center",
            } }, { children: [(0, jsx_runtime_1.jsx)(Typography_1.default, Object.assign({ sx: { textAlign: "center", marginTop: "1rem" }, variant: "h3" }, { children: "Bienvenido" }), void 0), (0, jsx_runtime_1.jsx)(Typography_1.default, Object.assign({ sx: { textAlign: "center" }, variant: "h5" }, { children: "sigue todos los pasos para configurar el sistema" }), void 0), (0, jsx_runtime_1.jsx)(Typography_1.default, Object.assign({ sx: { textAlign: "center", marginTop: "3rem", marginBottom: "1rem" }, variant: "h6" }, { children: "Crea tu usuario" }), void 0), (0, jsx_runtime_1.jsx)(CssTextField, { onChange: handleHostChange, sx: { marginY: "0.3rem" }, id: "setupHost", label: "Nombre", value: nombre }, void 0), (0, jsx_runtime_1.jsx)(CssTextField, { onChange: handlePortChange, sx: { marginY: "0.3rem" }, id: "setupHost", label: "Apellido", value: apellido, type: "text" }, void 0), (0, jsx_runtime_1.jsx)(CssTextField, { sx: { marginY: "0.3rem" }, id: "setupUser", label: "Correo", value: correo, onChange: handleUserChange, type: "email" }, void 0), (0, jsx_runtime_1.jsx)(CssTextField, { onChange: handlePasswordChange, type: "password", sx: { marginY: "0.3rem" }, id: "setupPass", label: "contrase\u00F1a", value: password }, void 0), (0, jsx_runtime_1.jsx)(ColorButton, Object.assign({ onClick: handledClick }, { children: "Continuar" }), void 0)] }), void 0) }), void 0));
}
