...
electron_1.ipcMain.handle("VALIDATE_CREDENTIALS", function () { return __awaiter(void 0, void 0, void 0, function () {
    var ConnectionDB_1, connect, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ConnectionDB_1 = require("./config/database");
                return [4 /*yield*/, ConnectionDB_1()];
            case 1:
                connect = _a.sent();
...
electron_1.ipcMain.handle("CREATE_CREDENTIALS_DB", function (event, credentials) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                connection = _a.sent();
                if (!connection.isConnected) return [3 /*break*/, 7];
...
electron_1.ipcMain.handle("LOGIN", function (event, user) { return __awaiter(void 0, void 0, void 0, function () {
    var ConnectionDB, connect, userDB, error_5, userJson;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ConnectionDB = require("./config/database");
                return [4 /*yield*/, ConnectionDB()];
            case 1:
                connect = _a.sent();
...
electron_1.ipcMain.handle("GET_PERIODO", function (e, _a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var ConnectionDB, connect, periodoDB, skip, error_6, periodoJson;
...
electron_1.ipcMain.handle("INSER_PERIODO", function (event, periodo) { return __awaiter(void 0, void 0, void 0, function () {
    var ConnectionDB, connect, periodoDB, error_7, periodoJson, error_8, error_9;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ConnectionDB = require("./config/database");
...
electron_1.ipcMain.handle("GET_AÑOS", function () { return __awaiter(void 0, void 0, void 0, function () {
    var ConnectionDB, connect, periodoDB, error_10, periodoJson;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ConnectionDB = require("./config/database");
            ...
            case 4:
                ...
                return [3 /*break*/, 5];
            case 5: return [4 /*yield*/, periodoDB.find({
                    select: ["anio"],
                    group: ["anio"],
                })];
            case 6:
